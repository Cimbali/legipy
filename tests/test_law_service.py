...
def test_published_law():
    ...
    assert law.url_legi == 'https://www.legifrance.gouv.fr/dossierlegislatif/JORFDOLE000024106525/'
...
def test_pending_law_proposal():
    ...
    assert law.url_legi == 'https://www.legifrance.gouv.fr/dossierlegislatif/JORFDOLE000025450258/'
...
def test_pending_law_project():
    ...
    assert law.url_legi == 'https://www.legifrance.gouv.fr/dossierlegislatif/JORFDOLE000026052216/'
